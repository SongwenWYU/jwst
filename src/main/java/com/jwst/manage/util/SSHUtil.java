...
import com.jwst.manage.db.PrivateKeyDB;
import com.jwst.manage.db.ProfileSystemsDB;
import com.jwst.manage.db.PublicKeyDB;
import com.jwst.manage.db.SystemDB;
import com.jwst.manage.db.SystemStatusDB;
import com.jwst.manage.model.ApplicationKey;
import com.jwst.manage.model.HostSystem;
import com.jwst.manage.model.SchSession;
import com.jwst.manage.model.SessionOutput;
import com.jwst.manage.model.UserSchSessions;
import com.jwst.manage.task.SecureShellTask;
...
public class SSHUtil {
	...
	public static final String KEY_PATH = DBUtils.class.getClassLoader().getResource("key").getPath();
	...
	public static void deleteGenSSHKeys() {
		...
		try {
			...
			log.debug("delete gen ssh key error");
		}
	}
