...
import com.jwst.manage.model.SessionAudit;
...
//            }
     ...
     * @return session id
     */
    public static Long createSessionLog() {
        //get db connection
        ...
        try {
            ...
            sessionId = createSessionLog(con);
     ...
     * @return session id
     */
    public static Long createSessionLog(Connection con) {
        Long sessionId = null;
        try {

            //insert
            PreparedStatement stmt = con.prepareStatement("insert into session_log values();", Statement.RETURN_GENERATED_KEYS);
            stmt.execute();
